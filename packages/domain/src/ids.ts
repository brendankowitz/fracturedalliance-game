...
export function asteroidId(raw: string): AsteroidId {
  return raw as AsteroidId;
}
export function buildingId(raw: string): BuildingId {
  return raw as BuildingId;
}
export function shipId(raw: string): ShipId {
  return raw as ShipId;
}
export function playerId(raw: string): PlayerId {
  return raw as PlayerId;
}
export function blueprintId(raw: string): BlueprintId {
  return raw as BlueprintId;
}
export function agentId(raw: string): AgentId {
  return raw as AgentId;
}
export function treatyId(raw: string): TreatyId {
  return raw as TreatyId;
}
