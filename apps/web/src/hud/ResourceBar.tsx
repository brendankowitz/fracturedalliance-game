      ...
      >
        <span
          style={{
            ...
            letterSpacing: 2,
            color: "var(--accent)",
            textShadow: "0 0 8px rgba(0,196,224,0.4)",
          }}
        >
          HELION CORP
        </span>
      ...
      >
        ...
        <span
          style={{
            ...
            fontWeight: "bold",
            color: "var(--amber)",
            textShadow: "0 0 8px rgba(255,146,0,0.35)",
            letterSpacing: 1,
          }}
        >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
          ...
          >
            <div
              style={{
                width: `${standingBar}%`,
                height: "100%",
                background: standingColor(federationStanding),
          ...
          <span
            style={{
              fontFamily: "var(--font-data)",
              fontSize: 10,
              color: standingColor(federationStanding),
              textAlign: "right",
            }}
          >
